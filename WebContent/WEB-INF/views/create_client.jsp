...
<div class="row" id="formEntry">
	<div
		class="col-lg-4 col-md-4 col-sm-4 container justify-content-center" id="divi">
		<h2>New client</h2>
		<form:form action="save" method="post" modelAttribute="clients">
			...
			<div class="mb-3 input-group">
				...
				<form:input path="passport_number" type="text" class="form-control col-sm-10"
					placeholder="Enter passport number" aria-label="Enter passport number"
					aria-describedby="basic-addon2" />
			</div>
